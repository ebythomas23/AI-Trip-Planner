...
class GooglePlaceSearchTool:
    ...
    def google_search_attractions(self,place:str)->dict:
        """
        Searchess for attractions in the specified place using GoogglePlaces API.
        """    
        return self.places_tool.run("Top attractive places in and around {place}?")
    
    def google_search_restaurants(self,place:str)->dict:
        """ Searchess for resturants in the specified place using GoogglePlaces API. """
        return self.places_tool.run("what are the top 10 restaurants and eateries in and around {place}?")
    

    def google_search_activity(self,place:str)->dict:
        """ Searchess for popular activities in the specified place using GoogglePlaces API. """
        return self.places_tool.run("Activities  in and around {place}?")
    
    def google_search_transportation(self,place:str)->dict:
        """ Searchess for available modes of transportations in the specified place using GoogglePlaces API. """
        return self.places_tool.run("what are the different modes of transportation available in {place}?")
...
class TavilyPlaceSearchTool:
    ...
    def tavily_search_attractions(self, place:str)->dict:
        """
        Searches for attractions i. the specified place using TavilySearch.
        """   
